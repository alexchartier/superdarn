...
Authors: Ashton S Reimer, Muhammad Rafiq, Kevin Sterne, Angeline Burrell
...
class fov(object):
    ...
    hop : Optianal[scalar or ndarray(ngates) or ndarray(nbeams,ngates)]
...
#    print "coords of result are " + fov1.coords
    ...
    print(
        "Expected: [-121.24209635 -121.27592761 -121.35103925 -121.44477957]")
