...
try:
    from globus_sdk.services.auth.errors import AuthAPIError as GlobusAuthAPIError
except Exception:
    from globus_sdk import GlobusAPIError as GlobusAuthAPIError
...
# CLIENT_ID = 'e70228d0-56a2-4d85-bf63-7fbccc92dcd3' app run by Rem
CLIENT_ID = '2871239b-8edb-4dca-adab-2ca354b304de'  # current APL ID
