"""
upload_all_files_to_zenodo.py

Upload all processed SuperDARN files to Zenodo

Terms:
    Zenodo - https://zenodo.org
"""  
import upload_fitacf_nc_to_zenodo
...
def main(date_string):
    ...
    print(f'Starting to upload all processed {date.strftime("%Y-%m")} files to Zenodo\n')
    upload_fitacf_nc_to_zenodo.main(date_string)
